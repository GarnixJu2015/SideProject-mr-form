...
function generatePdfContext(){
    ...
    var realNameEntry = document.getElementById('Widget1157282841').value;
    ...
    var billTableFooter = buildPdfTableFooter(orderData.total, 1125,  orderData.total+1125);

    // footer note
    var footerNote = buildPdfNote();
    var context = [
        generatePdfTitle(),
        generatePdfHeader(emailEntry, nameEntry, realNameEntry), 
        // ...billHeaderContext,
        '\n\n',
        billTable,
        billTableFooter,
    ...
    return {context: context, id: emailEntry};
}
...
async function useFetch(formData){
    var url = 'https://docs.google.com/forms/u/8/d/e/1FAIpQLScONqaaqZ8f99R8Va6UbskSzrwNKIQwael4ThC0aTEYPA61Ag/formResponse';
...
function connectGoogleForm(formData, email){
    ...
    return $.ajax({
        type: 'POST',
        url: 'https://docs.google.com/forms/u/8/d/e/1FAIpQLScONqaaqZ8f99R8Va6UbskSzrwNKIQwael4ThC0aTEYPA61Ag/formResponse',
        data: formData,
